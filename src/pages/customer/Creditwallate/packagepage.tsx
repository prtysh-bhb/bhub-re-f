  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800">
      ...
      <section className="container mx-auto max-w-6xl px-4 -mt-8 md:-mt-12 relative z-10">
        <div className="bg-white dark:bg-neutral-800 rounded-2xl shadow-xl p-6 grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
        ...
        <div className="mb-8 flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <select 
              ...
              className="px-3 py-2 bg-white dark:bg-neutral-800 border border-gray-300 dark:border-neutral-600 rounded-lg text-sm"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {packages.map((pkg, index) => {
              ...
              return (
                <div
                  key={pkg.id}
                  className={`relative bg-white dark:bg-neutral-800 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border ${
                    isPopular 
          ...
          <div className="mt-16 md:mt-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {[
                ...
                <div
                  key={index}
                  className="bg-white dark:bg-neutral-800 rounded-xl p-6 border border-gray-200 dark:border-neutral-700 hover:border-blue-300 dark:hover:border-blue-700 transition-colors"
                >
        ...
        <form onSubmit={handleSubmit} className="p-6">
          ...
          <div className="flex gap-3">
            <button
              type="button"
              onClick={() => setIsOpen(false)}
              className="flex-1 px-4 py-3 border border-gray-300 dark:border-neutral-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors font-medium"
              disabled={processing}
            >
              Cancel
            </button>
