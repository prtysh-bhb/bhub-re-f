...
const AgentDashboardPage = () => {
  ...
  // Property Statistics Cards with elegant primary colors
  const propertyStats = [
    {
  ...
  return (
    <>
      <div className="p-6 space-y-6 dark:bg-gradient-to-br dark:from-gray-900 dark:to-gray-950 bg-gradient-to-br from-slate-50 to-primary-50/30 min-h-screen">
        {/* Welcome Header */}
        <div className="bg-gradient-to-r from-primary-600 to-primary-700 p-8 rounded-2xl shadow-xl dark:shadow-2xl border-0 text-white relative overflow-hidden">
            ...
            return (
              <div key={index} className={`bg-gradient-to-br ${stat.bgGradientLight} dark:bg-gradient-to-br ${stat.bgGradientDark} rounded-2xl p-6 border border-gray-100 dark:border-gray-700/50 shadow-lg hover:shadow-xl dark:hover:shadow-2xl transition-all duration-300 hover:-translate-y-1`}>
                <div className="flex items-center justify-between">
                  ...
                  <div className={`p-3 rounded-xl bg-gradient-to-br ${stat.gradient} text-white shadow-lg dark:shadow-2xl`}>
          ...
          <Card className="lg:col-span-2 dark:bg-gray-800/50 bg-white border border-gray-100 dark:border-gray-700/50 shadow-xl dark:shadow-2xl">
            <CardContent className="p-6">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                ...
                <div className="flex items-center gap-2 px-3 py-1.5 dark:bg-primary-900/40 bg-primary-50 rounded-full dark:border-primary-800/50 border-primary-100 border">
                  <div className="w-2 h-2 bg-primary-500 rounded-full animate-pulse"></div>
                  <span className="dark:text-primary-300 text-primary-700 text-sm font-medium">
              ...
              <div className="space-y-3">
                {recentProperties.map((property) => (
                  <Link
                    ...
                    key={property.id}
                    className="block dark:bg-gradient-to-br dark:from-gray-800/50 dark:to-primary-900/20 bg-gradient-to-br from-white to-primary-50/70 dark:border-primary-800/50 border-primary-100 border rounded-xl p-4 hover:shadow-xl dark:hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 group hover:dark:border-primary-700/50 hover:border-primary-200"
                  >
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3">
                      {/* Property Info */}
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start gap-3">
                          <div className="hidden sm:flex flex-shrink-0 w-10 h-10 dark:bg-gradient-to-br dark:from-primary-900/40 dark:to-primary-900/30 bg-gradient-to-br from-primary-100 to-primary-100 rounded-lg items-center justify-center dark:border-primary-800/50 border-primary-200 border">
                            <Building2 className="w-5 h-5 dark:text-primary-400 text-primary-600" />
                          </div>
                          <div className="flex-1 min-w-0">
                            <h4 className="dark:text-white text-gray-900 font-semibold truncate group-hover:dark:text-primary-400 group-hover:text-primary-600 transition-colors text-sm sm:text-base">
                              {property.title}
                            </h4>
                            <div className="flex flex-col sm:flex-row sm:items-center gap-2 mt-2">
                              <span className="dark:text-primary-300 text-primary-600 dark:bg-primary-900/40 bg-primary-50 text-sm font-bold px-2 py-1 rounded-lg dark:border-primary-800/50 border-primary-100 border">
                    ...
                    <div className="sm:hidden flex items-center justify-between mt-3 pt-3 dark:border-gray-700/50 border-gray-100 border-t">
                      ...
                      <div className="dark:text-primary-400 text-primary-600 text-xs font-medium">
                        View Details →
                      </div>
                    </div>
                  </Link>
                ...
                {recentProperties.length === 0 && (
                  <div className="text-center py-12 px-4 dark:bg-gradient-to-br dark:from-gray-800/50 dark:to-primary-900/20 bg-gradient-to-br from-slate-50 to-primary-50/30 rounded-2xl border-2 border-dashed dark:border-primary-800/50 border-primary-200">
                    <div className="w-20 h-20 dark:bg-gradient-to-br dark:from-primary-900/40 dark:to-primary-900/30 bg-gradient-to-br from-primary-100 to-primary-100 rounded-full flex items-center justify-center mx-auto mb-4 dark:border-primary-800/50 border-primary-200 border">
                      <Building2 className="w-8 h-8 dark:text-primary-400 text-primary-400" />
                    </div>
                    ...
                    <Link
                      ...
                      className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-primary-500 to-primary-600 text-white rounded-xl font-semibold hover:shadow-lg dark:hover:shadow-2xl transition-all duration-300 hover:scale-105"
                    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {topProperties.map((property) => (
                <Link
                  to={'/agent/properties/'+property.id}
                  key={property.id}
                  className="dark:bg-gradient-to-br dark:from-gray-800/50 dark:to-primary-900/20 bg-gradient-to-br from-white to-primary-50/50 dark:border-primary-800/50 border-primary-100 border rounded-xl p-5 hover:shadow-xl dark:hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 group"
                >
                  <div className="flex items-start justify-between mb-4">
                    <h4 className="dark:text-white text-gray-900 font-bold line-clamp-2 group-hover:dark:text-primary-400 group-hover:text-primary-600 transition-colors">
                      {property.title}
                    </h4>
                    {getStatusBadge(property.status)}
                  </div>
                  <p className="dark:text-primary-400 text-primary-600 text-xl font-bold mb-3">{formatAmount(property.price)}</p>
                  <div className="flex items-center justify-between">
                    ...
                    <div className={`px-3 py-1.5 rounded-full text-xs font-bold ${
                      property.inquiries_count > 5
                        ? 'dark:bg-gradient-to-r dark:from-primary-900/40 dark:to-primary-800/30 bg-gradient-to-r from-primary-100 to-primary-50 dark:text-primary-300 text-primary-700 dark:border-primary-800/50 border-primary-200 border'
