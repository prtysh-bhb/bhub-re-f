              ...
              <CardContent className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 bg-primary-50 dark:bg-primary-900/30 rounded-xl border border-primary-200 dark:border-primary-800/50">
                      ...
                      <div className="text-right">
                        <p className="text-sm font-semibold text-primary-600 dark:text-primary-400">{reminder?.customer?.email ?? ''}</p>
                  ...
                  <div className="space-y-4">
                    ...
                    {reminder.inquiry && (
                      <div className="flex items-center justify-between p-4 bg-primary-50 dark:bg-primary-900/30 rounded-xl border border-primary-200 dark:border-primary-800/50">
                        ...
                        <span className="text-xl font-bold text-primary-600 dark:text-primary-400">#{reminder.inquiry.id}</span>
                      </div>
                    )}

                    {/* Appointment Information */}
                    {reminder.appointment && (
                      <div className="flex items-center justify-between p-4 bg-amber-50 dark:bg-amber-900/30 rounded-xl border border-amber-200 dark:border-amber-800/50">
                        <div className="flex items-center gap-3">
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Badge className="bg-primary-100 text-primary-800 border-primary-200 dark:bg-primary-900/30 dark:text-primary-400 dark:border-primary-800/50 capitalize">
                      {reminder.type}
                    </Badge>
                  </div>
                  <div className="flex items-center justify-between">
