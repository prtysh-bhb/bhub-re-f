    ...
    <>
      <div className="p-6 space-y-6 bg-gradient-to-br from-neutral-50 via-primary-50/10 to-neutral-50 dark:from-neutral-950 dark:via-primary-950/5 dark:to-neutral-950 min-h-screen">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* User Registrations */}
          <Card className="bg-gradient-to-br from-white via-white to-primary-50/30 dark:from-neutral-900 dark:via-neutral-900 dark:to-primary-950/20 border border-neutral-200/50 dark:border-neutral-800/50 shadow-lg shadow-neutral-200/50 dark:shadow-black/20 rounded-2xl hover:shadow-xl hover:shadow-primary-200/20 dark:hover:shadow-primary-900/10 hover:-translate-y-0.5 transition-all duration-300">
